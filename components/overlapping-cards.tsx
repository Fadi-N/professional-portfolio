...
export default function OverlappingCards() {
    ...
    const cards = [
        {
            cardY: useTransform(scrollYProgress, [0.4, 0.95], [100, -160]),
            bgColor: "bg-[#ccb987]",
            year: "2024",
            shortcut: "Website | 3D Model",
            title: "Bringing the iPhone to life in 3D",
            subtitle:
                "An immersive, real-time 3D experience built with Three.js & React Three Fiber",
            description1: {
        ...
        {
            cardY: useTransform(scrollYProgress, [0.3, 0.95], [280, -120]),
            bgColor: "bg-[#79a978]",
            year: "2023",
            shortcut: "Website | PIM",
            title: "Transforming Content Creation with PIM Editor",
            subtitle:
                "A dynamic tool for building product pages, blogs, and fully customizable views",
            description1: {
                title: "Limitless Customization",
                description:
                    "Prebuilt components, sliders, and flexible content blocks allow for unique layouts.",
            },
            description2: {
                title: "JSON-Driven & Real-Time Rendering",
                description:
                    "Every structure is powered by JSON, seamlessly converting into fully-rendered HTML.",
            },
            stack: "JavaScript, React, Redux, Bootstrap 5, JSON",
            src: "/sample.jpg",
        },
        {
            cardY: useTransform(scrollYProgress, [0.45, 0.95], [340, -80]),
            bgColor: "bg-[#74b5a5]",
            year: "2022",
            shortcut: "Website | RentMe",
            title: "A Seamless Property Rental Experience",
            subtitle:
                "Effortless booking, secure authentication, and personalized listings in one platform.",
            description1: {
        ...
        {
            cardY: useTransform(scrollYProgress, [0.6, 0.95], [380, -40]),
            bgColor: "bg-[#6ba6ef]",
            year: "2025",
        ...
        {
            cardY: useTransform(scrollYProgress, [0.75, 0.95], [420, 0]),
            bgColor: "bg-[#9c9cf8]",
            year: "2025",
    ...
    return (
        <div className="overlapping-cards relative">
            {cards.map((card, index) => (
                <motion.div
                    key={index}
                    style={{ y: card.cardY }}
                    // Możesz eksperymentować z wysokością – tutaj 70vh
                    className="sticky top-0 min-h-[70vh] flex items-center justify-center z-30"
                >
                        ...
                        <div className="overlapping-card-body">
                            <div className="flex flex-col space-y-2">
                                <div className="flex items-baseline md:items-center justify-between">
                                    <h1>{card.title}</h1>
                                    <FaArrowRight className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl 2xl:text-6xl transform transition-transform duration-300 hover:-rotate-45" />
                                </div>
